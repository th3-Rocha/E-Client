              ...
              <div class="card border-0 shadow-lg">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <asp:GridView AutoGenerateColumns="False" ID="CLIList" runat="server" CssClass="table table-hover table-striped"  DataKeyNames="CLI_ID" OnRowCommand="CLIList_RowCommand" > 
                            <Columns>
